...
class Program
{
    ...
    static void AdicionarLivro()
    {
        ...
        string idiomaNativoAutor = Console.ReadLine();

        Autor autor = new Autor(nomeAutor, paisOrigemAutor, dataNascimentoAutor, idiomaNativoAutor);
        Livro livro = new Livro(isbn, nome, autor, idioma, edicao, dataLancamento);
